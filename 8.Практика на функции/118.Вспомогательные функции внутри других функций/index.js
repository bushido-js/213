...
Мой вопрос, как быть при работе с вспомогательными функциями и циклами, ведь не всегда будет очевидно, что переменна i, уже используется, как поступать в таком случае, всегда, если возможно использовать циклы через of или in?*/